...
BOOST_AUTO_TEST_SUITE(dust_strtoint64_tests)

BOOST_AUTO_TEST_CASE(dust_strtoint64_invidisible)
{
    // zero amount
...
BOOST_AUTO_TEST_CASE(dust_strtoint64_invidisible_truncate)
{
...
BOOST_AUTO_TEST_CASE(dust_strtoint64_invidisible_invalid)
{
...
BOOST_AUTO_TEST_CASE(dust_strtoint64_divisible)
{
...
BOOST_AUTO_TEST_CASE(dust_strtoint64_divisible_truncate)
{
    // truncate after 8 digits
    BOOST_CHECK(StrToInt64("40.00000000000099", true) == static_cast<int64_t>(4000000000U));
    BOOST_CHECK(StrToInt64("92233720368.54775807000", true) == static_cast<int64_t>(9223372036854775807U));
...
BOOST_AUTO_TEST_CASE(dust_strtoint64_divisible_invalid)
{
    // invalid, number is over max int64
