...
BOOST_AUTO_TEST_SUITE(dust_rounduint64_tests)

BOOST_AUTO_TEST_CASE(dust_rounduint64_simple)
{
...
BOOST_AUTO_TEST_CASE(dust_rounduint64_whole_units)
{
...
BOOST_AUTO_TEST_CASE(dust_rounduint64_round_below_point_5)
{    
...
BOOST_AUTO_TEST_CASE(dust_rounduint64_round_point_5)
{    
...
BOOST_AUTO_TEST_CASE(dust_rounduint64_round_over_point_5)
{    
...
BOOST_AUTO_TEST_CASE(dust_rounduint64_limits)
{    
...
BOOST_AUTO_TEST_CASE(dust_rounduint64_types)
{
    BOOST_CHECK_EQUAL(
...
BOOST_AUTO_TEST_CASE(dust_rounduint64_promotion)
{
...
BOOST_AUTO_TEST_CASE(dust_rounduint64_absolute)
{
    BOOST_CHECK_EQUAL(
            rounduint64(-128.0f),
            rounduint64(128.0f));
...
BOOST_AUTO_TEST_CASE(dust_rounduint64_special_cases)
{    
