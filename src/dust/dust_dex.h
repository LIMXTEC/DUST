...
private:
  int offerBlock;
  uint64_t offer_amount_original; // the amount of DST for sale specified when the offer was placed
...
{
private:
  uint64_t accept_amount_original;    // amount of DST desired to purchased
  uint64_t accept_amount_remaining;   // amount of DST/TDST remaining to purchased
// once accept is seen on the network the amount of DST being purchased is taken out of seller's SellOffer-Reserve and put into this Buyer's Accept-Reserve
