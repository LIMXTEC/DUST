...
enum MPRPCErrorCode
{
    ...
    MP_TX_IS_NOT_DUST_PROTOCOL  = -3336,  // Not a Dust Protocol transaction.
};
...
inline std::string error_str(int ec) {
  ...
  switch (ec)
  {
      ...
      case MP_INPUT_NOT_IN_RANGE:
          ec_str = "Input value supplied larger than supported in Dust Protocol";
          break;
